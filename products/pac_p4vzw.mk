...
ifeq (pac_p4vzw,$(TARGET_PRODUCT))

# OVERLAY_TARGET adds overlay asset source
OVERLAY_TARGET := pa_p4xxx

# AOKP device overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pac/overlay/aokp/device/p4vzw
...
$(call inherit-product, device/samsung/p4vzw/cm.mk)

PRODUCT_NAME := pac_p4vzw
